  ...
  group "registry" {
    ...
    task "registry" {
      ...
      config {
        ...
        labels {
          traefik.enable                                      = "true"
          traefik.http.routers.registry-prod.rule             = "Host(`registry-prod.apps.509ely.com`)"
          traefik.http.routers.registry-prod.entrypoints      = "websecure"
          traefik.http.routers.registry-prod.tls.certresolver = "myresolver"
        }
      }
