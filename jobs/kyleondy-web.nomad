...
job "kyleondy.com" {
  ...
  group "web" {
    ...
    # to 1.
    count = 3 # todo: how many for real? One per node seems reasonable
    ...
    task "nginx" {
      ...
      service {
        ...
        tags = [
          "traefik.enable=true",
          "traefik.http.routers.kyleondy-prod.rule=Host(`www.kyleondy.com`)",
          "traefik.http.routers.kyleondy-prod.entrypoints=websecure",
          "traefik.http.routers.kyleondy-prod.tls=true",
          "traefik.http.routers.kyleondy-prod.tls.certresolver=myresolver",
        ]
        port = "web"
        check {
          type     = "http"
