{
  ...
  outputs = { self, nixpkgs, deploy-rs }: {
    ...
    deploy.nodes.m2 = {
      #hostname = "m2.dmz.509ely.com"; # 10.25.89.12
      hostname = "10.25.89.12";
      fastConnection = true;
      profiles = {
        system = {
          sshUser = "root";
          path =
            deploy-rs.lib.aarch64-linux.activate.nixos self.nixosConfigurations.m2;
        };
      };
    };
    deploy.nodes.m3 = {
      #hostname = "m3.dmz.509ely.com";
      hostname = "10.25.89.13";
      fastConnection = true;
      profiles = {
        system = {
          sshUser = "root";
          path =
            deploy-rs.lib.aarch64-linux.activate.nixos self.nixosConfigurations.m3;
        };
      };
    };
    deploy.nodes.w1 = {
      #hostname = "w1.dmz.509ely.com"; # 10.25.89.21
      hostname = "10.25.89.21";
      fastConnection = true;
      profiles = {
        system = {
          sshUser = "root";
    ...
    deploy.nodes.w2 = {
      #hostname = "w2.dmz.509ely.com"; # 10.25.89.22
      hostname = "10.25.89.22";
      fastConnection = true;
      profiles = {
        system = {
          sshUser = "root";
    ...
    deploy.nodes.w3 = {
      #hostname = "w3.dmz.509ely.com" # 10.25.89.23
      hostname = "10.25.89.23";
      fastConnection = true;
      profiles = {
        system = {
          sshUser = "root";
